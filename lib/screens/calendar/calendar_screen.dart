...
class _TripCalendarScreenState extends State<TripCalendarScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          title: const Center(child: Text('Trip Calendar')),
        ),
        body: SfCalendar(
  ...
  List<Meeting> _getDataSource() {
    ...
    final DateTime endTime = startTime.add(Duration(days: 3));
    meetings.add(Meeting(
        'Trip to Mombasa', startTime, endTime, Theme.of(context).primaryColor, false));
    return meetings;
  }
}
