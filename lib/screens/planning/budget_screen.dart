...
class BudgetTab extends StatefulWidget {
  const BudgetTab({super.key, required this.tripDays, required this.budget});
            ...
            children: [
                ...
                child: Column(
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Text(
                          'Ksh. ${formatter.format(total).toString()}',
                          style: TextStyle(
                            fontSize: 25,
                    ...
                    //         percent: 0.8,
                    //         center: Text(
                    //           "Ksh ${formatter.format(totalBudget).toString()}",
                    //           style: TextStyle(
                    //               fontSize: 14.0,
                    //               fontWeight: FontWeight.w600,
                    //               color: Colors.white),
              ...
              ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  totalBudget += dailyActivities.morningBudget;
                  totalBudget += dailyActivities.afternoonBudget;
                  totalBudget += dailyActivities.eveningBudget;
