...
class UserChangeForm(forms.ModelForm):
    ...
    class Meta:
        model = User
        fields = ('email', 'password', 'name', 'phone','dob','image' ,'is_active', 'is_staff', 'is_superuser',)
...
class UserAdmin(BaseUserAdmin):
    ...
    fieldsets = (
        ...
        ('Personal info', {'fields': ('name','phone','dob','image')}),
    ...
    add_fieldsets = (
        (None, {
            'classes': ('wide',),
            'fields': ('email', 'name', 'phone','dob',"image", 'password1', 'password2'),
        }),
    )
    search_fields = ('email',)
    ordering = ('email',)
